...
class _AddProductPageState extends State<AddProductPage> {
  ...
  final List<CategoryModel> categories = [
    //buat dropdown
    //value harus sama dgn ada yg di database/laravel
      ...
      body: ListView(
        ...
        children: [
          ...
          CustomDropdown<CategoryModel>(
            value: categories.first, //pake first, agar data tunggal pertama yg mau diakses/dicari bisa ditampilin dg sesuai
            items: categories,
